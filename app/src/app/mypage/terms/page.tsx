...
export default function TermsPage() {
  return (
    <PolicyPage
      ...
      addendum="부칙: 본 약관은 2026년 9월 21일부터 시행됩니다."
    >
      ...
      <PolicySection title="제2조 (정의)">
        <ol className="list-decimal space-y-1 pl-5">
          <li>
            &quot;서비스&quot;란 카테고리를 고르면 챌린지를 뽑아 주고, 진행 기록을 남길 수 있게 하는
            일체의 기능을 의미합니다.
          </li>
      ...
      <PolicySection title="제4조 (회원가입 및 계정)">
        <ol className="list-decimal space-y-1 pl-5">
          <li>
      ...
      <PolicySection title="제5조 (서비스의 제공 및 변경)">
        <ol className="list-decimal space-y-1 pl-5">
          ...
          <li>
            회사는 서비스를 연중무휴 제공하기 위해 노력하나, 시스템 점검·교체 또는 불가항력적 사유가
            있는 경우 일시 중단할 수 있습니다.
          </li>
        </ol>
      </PolicySection>

      <PolicySection title="제6조 (회원의 의무)">
        <ol className="list-decimal space-y-1 pl-5">
      ...
      <PolicySection title="제7조 (서비스 이용 제한)">
        <p>
      ...
      <PolicySection title="제8조 (계약 해지 및 탈퇴)">
        <ol className="list-decimal space-y-1 pl-5">
          <li>
      ...
      <PolicySection title="제10조 (분쟁 해결 및 준거법)">
        <ol className="list-decimal space-y-1 pl-5">
