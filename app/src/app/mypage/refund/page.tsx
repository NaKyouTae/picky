      ...
      <article className="space-y-6 px-5 pb-6 pt-4 text-sm leading-relaxed text-ink-sub">
        ...
        <section>
          ...
          <ol className="list-decimal space-y-2 pl-5">
            <li>
              회원은 유료 서비스 결제일로부터 <b>7일 이내</b>에 청약철회를 신청할 수 있습니다.
            </li>
            <li>
        ...
        <section>
          <h2 className="mb-2 text-sm font-semibold text-ink">3. 회사의 귀책사유로 인한 환불</h2>
          <p>
            서비스 결함, 장기간 서비스 장애 등 회사의 귀책사유로 정상적인 서비스 이용이 불가능한
            경우, 회원은 이용 기간과 관계없이 전액 환불을 요청할 수 있습니다.
          </p>
        </section>
        ...
        <section>
          ...
          <a
            href={MAILTO}
            className="mt-4 flex h-12 items-center justify-center gap-2 rounded-2xl bg-brand-500 text-sm font-semibold text-white active:bg-brand-600"
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
        ...
        <section>
          ...
          <ol className="list-decimal space-y-2 pl-5">
            ...
            <li>
              결제 수단별 환불 처리에는 영업일 기준 3~7일이 소요될 수 있으며,
              카드사·은행·간편결제사의 정책에 따라 추가 시간이 소요될 수 있습니다.
            </li>
          </ol>
        </section>
        ...
        <p className="text-right text-xs">부칙: 본 환불정책은 2026년 9월 21일부터 시행됩니다.</p>
      </article>
    </div>
  );
}
